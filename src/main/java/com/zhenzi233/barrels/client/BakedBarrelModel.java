...
public class BakedBarrelModel extends BakedModelWrapper<IBakedModel> {
    ...
    public BakedBarrelModel(IBakedModel originalModel, IModel barrelModel, VertexFormat format) {
        super(originalModel);
    ...
    public ItemOverrideList getOverrides() {
        return BakedBarrelModel.BarrelItemOverrideList.INSTANCE;
    }
